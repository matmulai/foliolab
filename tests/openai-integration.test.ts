...
describe("OpenAI Integration", () => {
  ...
  describe("Repository Summary Generation", () => {
    it("should generate summary for repository with README", async () => {
      const mockSummary = {
        summary:
          "This is a React-based web application that provides a modern user interface for managing tasks.",
        keyFeatures: [
    ...
    it("should handle repository without README", async () => {
      const mockSummary = {
        summary:
          "This appears to be a Node.js Express API server based on the project structure and dependencies.",
        keyFeatures: [
    ...
    it("should handle API errors gracefully", async () => {
      ...
      await expect(
        mockGenerateRepoSummary("test-repo", "Test repository", "Test README", "invalid-api-key"),
      ).rejects.toThrow("OpenAI API rate limit exceeded");
    });

    it("should validate required parameters", async () => {
      mockGenerateRepoSummary.mockImplementation((name, _description, _readme, apiKey) => {
  ...
  describe("User Introduction Generation", () => {
    it("should generate user introduction from repositories", async () => {
      ...
      const mockIntroduction = {
        introduction:
          "I am a full-stack developer passionate about building modern web applications with React and Node.js.",
  ...
  describe("Error Handling", () => {
    it("should handle network errors", async () => {
      ...
      await expect(mockGenerateRepoSummary("repo", "desc", "readme", "key")).rejects.toThrow(
    ...
    it("should handle authentication errors", async () => {
      ...
      await expect(
        mockGenerateRepoSummary("repo", "desc", "readme", "invalid-key"),
    ...
    it("should handle timeout errors", async () => {
      ...
      await expect(mockGenerateUserIntroduction([], "key")).rejects.toThrow("Request timeout");
    });
  });
